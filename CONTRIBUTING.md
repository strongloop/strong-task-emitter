...
Thank you for your interest in `strong-task-emitter`, an open source project
administered by StrongLoop.

Contributing to `strong-task-emitter` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-task-emitter)
